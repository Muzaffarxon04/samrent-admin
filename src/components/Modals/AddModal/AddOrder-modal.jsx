...
export default function AddOrderModal({ getDatas, company }) {
  ...
  const onFinish = () => {
    ...
    formik.values.short_inforu = "";
    formik.values.short_infoen = "";
    formik.values.ingredientsuz = "";
    formik.values.ingredientsru = "";
    formik.values.ingredientsen = "";
    formik.values.long_infouz = "";
    formik.values.long_inforu = "";
    formik.values.long_infoen = "";
    formik.values.nutritional_infouz = "";
    formik.values.nutritional_inforu = "";
    formik.values.nutritional_infoen = "";
  };
